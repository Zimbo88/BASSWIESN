...
def build_feature_status(db: Session) -> list[dict]:
    ...
    features = [
        ...
        _feature(
            ...
            description="Lokaler Senderkatalog mit Streamanalyse und expliziter Wiedergabe.", maturity="Kern",
        ...
        _feature(
            ...
            requirements=["Radio erreichbar", "Nur-lesend-/presets-Readback"], navigation_target=_target("presets"),
            documentation=_doc("testing", "Testkonzept"), safe_test_available=True,
            security_status="Nur lesend; kein Radio-Write im Statuszentrum",
        ),
        _feature(
        ...
        _feature(
            ...
            security_status="Nur-lesend-Vorschau; Live-Write nur mit bestehenden Guards",
        ),
        _feature(
            ...
            documentation=_doc("testing", "Testkonzept"), safe_test_available=True,
            security_status="Vorschau und Schutz-IP vor Live-Write",
        ),
        _feature(
        ...
        _feature(
            ...
            security_status="Einstellungen werden im Backup redigiert",
        ),
        _feature(
            feature_id="restore", title="Restore", category="Sicherung und Diagnose",
            description="Backup-Vorschau und Restore-Vorbereitung sind vorhanden; vollständiger sicherer UI-Restore fehlt.", maturity="Infrastruktur",
            ...
            security_status="Restore bleibt Vorschau/Prepare; kein stiller Web-Restore",
        ),
        _feature(
        ...
        _feature(
            ...
            requirements=["Geräte-Allowlist", "Secretquelle per Environment/Datei", "Kompatibles Profil", "Hardwaretest"],
        ...
        _feature(
            ...
            description="Vorschau- und Jobinfrastruktur für begrenzte Ansagen; keine bestätigte Wiedergabe.", maturity="Experimentell",
        ...
        _feature(
            ...
            security_status="LAB; Vorschau und Bestätigung vor Live-Aktion",
        ),
        _feature(
