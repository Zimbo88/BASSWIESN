            ...
            <section class="view" id="view-multiroom">
              ...
              <div class="multiroom-grid clean-grid">
                <section class="panel focus-panel">
                  ...
                  <details class="single-room-remove"><summary>Mitglied aus laufender Gruppe entfernen</summary><p class="muted-copy">Entfernt nur dieses Radio aus der aktuellen Zone. Das Radio bleibt in BASSWIESN gespeichert.</p><div id="multiroom-remove-device" class="radio-button-picker"></div><button class="command" id="multiroom-remove" type="button">Mitglied entfernen</button></details>
                </section>
                <section class="panel">
